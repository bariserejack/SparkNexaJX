...
export default function CustomDrawerContent(props: any) {
  ...
  const quickAccessLinks: Array<{ label: string; icon: keyof typeof Ionicons.glyphMap; path: string }> = [
    ...
    { label: 'NexaMarket', icon: 'cart-outline', path: '/marketplace' },
    { label: 'SafeKeep', icon: 'file-tray-full-outline', path: '/vault' },
    { label: 'Secure Vault', icon: 'wallet-outline', path: '/secure-vault' },
